...
import createStatsCollector from './stats-collector.mjs';
import {
...
if (!utils.isBrowser() && typeof paths !== 'undefined') {
  var cwd = utils.cwd();
  paths.push(cwd, path.join(cwd, 'node_modules'));
}
 ...
 * @memberof Mocha
 */
const reporters = builtinReporters;
export { reporters };
export { default as Runnable } from './runnable.mjs';
export { default as Context } from './context.mjs';
/**
 *
 * @memberof Mocha
 */
export { default as Runner } from './runner.mjs';
export { Suite };
 ...
 * @chainable
 */
cleanReferencesAfterRun(cleanReferencesAfterRun) {
 ...
 * @chainable
 */
passOnFailingTestSuite(passOnFailingTestSuite) {
 ...
 * @returns {import("./runner.mjs").default} runner instance
 * @example
 *
 ...
 * @returns {Mocha}
 */
enableGlobalSetup(enabled = true) {
