 ...
 */
export const canonicalType = function canonicalType(value) {
  if (value === undefined) {
    return 'undefined';
  } else if (value === null) {
    return 'null';
 ...
 */
export const type = function type(value) {
  // Null is special
 ...
 */
export const canonicalize = function canonicalize(value, stack, typeHint) {
 ...
 * @returns {Function}
 */
export const stackTraceFilter = function () {
 ...
 */
export const isPromise = function isPromise(value) {
  return (
    typeof value === 'object' &&
    value !== null &&
 ...
 */
export const clamp = function clamp(value, range) {
 ...
 */
export const defineConstants = function (obj) {
 ...
 * @returns {Array<*>}
 */
export const castArray = function castArray(value) {
  if (value === undefined) {
    return [];
  }
  if (value === null) {
